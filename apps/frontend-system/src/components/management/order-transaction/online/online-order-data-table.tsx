...
import { OrderItemTable } from "./online-order-item-table";
import { columnsOrderItem } from "./online-order-item-column";

type OrderResponse = z.infer<typeof OrderData>;

interface DataTableProps<TData extends OrderResponse, TValue> {
...
export function OrderListDataTable<TData extends OrderResponse, TValue>({
  columns,
  data,
  pageCount,
  pagination,
